...
ホロライブ公式ショップでデジタルコンテンツを購入しているうちに、ライブラリーが何ページにもなって探しづらくなったため、自分用に本棚UIを作成しました。同じ不便を感じている方にも役立ててもらえればと思い公開しています。
...
> **注意**: この拡張はショップのHTML構造に依存しています。ショップ側の仕様変更により、一時的に動作しなくなる場合があります。
...
- **インラインプレイヤー**: カードをクリックするとトラック一覧を展開、ページ遷移なしでその場で再生
...
[最新リリース](https://github.com/f2sk/holoshop-shelf/releases/latest)から「Source code (zip)」をダウンロードして展開します。

Git を使う場合は `git clone https://github.com/f2sk/holoshop-shelf.git` でも OK です。
